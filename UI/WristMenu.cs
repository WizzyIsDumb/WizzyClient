...
namespace MalachiTemp.UI
{
    ...
    */
    ...
    {
        public static string MenuTitle = "Wizzy Client"; // this is the menu name, you can change it to whatever you want
        ...
        public static List<ButtonInfo> buttons = new List<ButtonInfo> // main
        {
            ...
            new ButtonInfo { buttonText = "Movement", method =() => Mods.Cat1(), enabled = false, toolTip = "Go to Movement!"},
            new ButtonInfo { buttonText = "Rig Mods", method =() => Mods.Cat2(), enabled = false, toolTip = "Go to Rig Mods!"},
            new ButtonInfo { buttonText = "Visual Mods", method =() => Mods.Cat3(), enabled = false, toolTip = "Go to Visual Mods!"},
            new ButtonInfo { buttonText = "Saftey", method =() => Mods.Cat4(), enabled = false, toolTip = "Go to Saftey!"},
            new ButtonInfo { buttonText = "Op Mods", method =() => Mods.Cat5(), enabled = false, toolTip = "Go to Op Mods!"},
            new ButtonInfo { buttonText = "Entity Mods", method =() => Mods.Cat6(), enabled = false, toolTip = "Go to Entity Mods!"},
        ...
        public static List<ButtonInfo> settingsbuttons = new List<ButtonInfo> // settings
        {
            ...
            new ButtonInfo { buttonText = "Custom Boards", method =() => Mods.Moo(), enabled = true, nontoggleable = true, toolTip = "Custom Message Of The Day!"},
        ...
        {
            new ButtonInfo { buttonText = "Exit Movement", method =() => Mods.Cat1(), enabled = false, toolTip = "Go to Main!"},
            ...
            new ButtonInfo { buttonText = "Slip Slap", method =() => Mods.SlipSLAP(), enabled = false, toolTip = "Slip slap!"},
        ...
        public static List<ButtonInfo> CatButtons2 = new List<ButtonInfo>
        {
            ...
            new ButtonInfo { buttonText = "Rig Gun", method =() => Mods.ExampleOnHowToUseGunLibV2(), enabled = false, toolTip = "Makes rig go where ever gun is!"},
            ...
            new ButtonInfo { buttonText = "Stop Fingers", method =() => Mods.NoFingerMovement(), enabled = false, toolTip = "Cant move fingers!"},
            new ButtonInfo { buttonText = "Grip Rig", method =() => Mods.GripRig(), enabled = false, toolTip = "Is you gripping daddy!"},
            new ButtonInfo { buttonText = "Scary Rig Test", method =() => Mods.TestGun(), enabled = false, toolTip = "Is scary ig" },
        ...
        {
            new ButtonInfo { buttonText = "Exit Visual Mods", method =() => Mods.Cat3(), enabled = false, toolTip = "Go to Main!"},
            new ButtonInfo { buttonText = "Tracers", method =() => Mods.Tracers(), enabled = false, toolTip = "Lines towards everyone!"},
            new ButtonInfo { buttonText = "Admin Badge(CS)", method =() => Mods.Tracers(), enabled = false, toolTip = "Gives admin badge!"},
            new ButtonInfo { buttonText = "Bubbles Gun Test(CS)", method =() => Mods.BubbleGunTest(), enabled = false, toolTip = "Testing bubbles shit!"},
            new ButtonInfo { buttonText = "Become Skelly(CS)", method =() => Mods.BecomeSkelly(), enabled = false, toolTip = "Makes you skeleton!"},
        ...
        {
            new ButtonInfo { buttonText = "Exit Saftey", method =() => Mods.Cat4(), enabled = false, toolTip = "Go to Main!"},
            new ButtonInfo { buttonText = "Rpc Protection(UD)", method =() => Mods.RPCPROTECTION(), enabled = false, toolTip = "Protects from rpc ban!"},
            new ButtonInfo { buttonText = "Anti Report(UD)", method =() => Mods.AntiReportNOWAYY(), enabled = false, toolTip = "disconnect when try report!"},
            new ButtonInfo { buttonText = "Anti Afk Kick", method =() => Mods.AntiAFK(), enabled = false, toolTip = "No kick when put down headset!"},
        ...
        public static List<ButtonInfo> CatButtons5 = new List<ButtonInfo>
        {
            ...
            new ButtonInfo { buttonText = "Start All Arcades(UD)", method =() => Mods.StartAllArcade(), enabled = false, toolTip = "Start all arcade machines!"},
        ...
        {
            new ButtonInfo { buttonText = "Exit Entity Mods", method =() => Mods.Cat6(), enabled = false, toolTip = "Go to Main!"},
            new ButtonInfo { buttonText = "Big Bug(CS)", method =() => Mods.BigDoug(), enabled = false, toolTip = "Makes bug big!"},
            new ButtonInfo { buttonText = "Big Bat(CS)", method =() => Mods.BigBat(), enabled = false, toolTip = "Makes bat big!"},
            new ButtonInfo { buttonText = "Bug Gun(CS)", method =() => Mods.ExampleOnHowToUseGunLib(), enabled = false, toolTip = "Shoots bug where ever gun is!"},
            new ButtonInfo { buttonText = "Bat Gun(CS)", method =() => Mods.BatGun(), enabled = false, toolTip = "Shoots bat where ever gun is!"},
        };
        #endregion
        #region Category 7
        ...
        void Update()
        {
            try
            {
                ...
                if (!Directory.Exists("Malachis_Temp"))
                {
